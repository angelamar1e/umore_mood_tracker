...
import 'package:umore_mood_tracker/features/profile/view/profile_view.dart';
import 'package:umore_mood_tracker/features/start/views/start_view.dart';
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder:
              (context, state) => BlocProvider(
                create: (context) => MoodStatsCubit(),
                child: const MoodStatsView(),
              ),
        ),
        GoRoute(
          path: 'profile',
